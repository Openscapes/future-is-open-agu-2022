...
-   **Open science is process, not only products**
    -   § It should engage, empower, amplify
    -   § It is a daily practice
-   **"Future us" mindset**
-   **Power of yet** (growth mindset)
-   **Onboard learners as contributors** through shared documentation
...
### we'll discuss these values through stories \* \*\*

\* all examples cross all categories

\*\* it is so difficult to choose and categorize
...
::: {.column width="80%"}
::: borderbox
[![](images/cookbook.png){fig-alt="Screenshot of Quarto site for a NASA Cloud Cookbook" width="52%"}](https://nasa-openscapes.github.io/earthdata-cloud-cookbook/)
:::
:::
...
::: notes
2)  How are you practicing open science in your research/activities? This is how we practice Open Science
:::
...
::: notes
When I started Openscapes, web-first mindset. what was possible
:::
...
## THANK YOU!!! Selected resources {.small}
